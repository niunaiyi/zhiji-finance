...
// 超级管理员
User::updateOrCreate(['email' => 'admin@admin.com'], ['name' => 'Super Admin', 'password' => 'password', 'is_super_admin' => true]);

// 账套1
\$c1 = Company::updateOrCreate(['code' => 'ACC01'], ['name' => '账套1', 'status' => 'active']);
\$u1 = User::updateOrCreate(['email' => 'admin@acc01.com'], ['name' => 'ACC01 Admin', 'password' => 'password']);
...
\$u2 = User::updateOrCreate(['email' => 'admin@acc02.com'], ['name' => 'ACC02 Admin', 'password' => 'password']);
