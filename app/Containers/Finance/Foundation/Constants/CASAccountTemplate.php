...
namespace App\Containers\Finance\Foundation\Constants;

/**
 * CAS (Chinese Accounting Standards) 会计准则模板常量类。
 * 包含 2007/2013 新会计准则下的标准一级会计科目列表。
 * 用于新账套初始化时的科目自动生成。
 */
final class CASAccountTemplate
{
