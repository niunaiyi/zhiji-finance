...
// 创建账套1
$c1 = Company::where('code', 'ACC01')->first() ?: Company::create(['code' => 'ACC01', 'name' => '账套1', 'status' => 'active']);
$u1 = User::where('email', 'admin@acc01.com')->first() ?: new User();
$u1->name = 'ACC01 Admin';
$u1->email = 'admin@acc01.com';
$u1->password = 'password';
$u1->save();
UserCompanyRole::updateOrCreate(['user_id' => $u1->id, 'company_id' => $c1->id], ['role' => 'admin']);

// 创建账套2
$c2 = Company::where('code', 'ACC02')->first() ?: Company::create(['code' => 'ACC02', 'name' => '账套2', 'status' => 'active']);
$u2 = User::where('email', 'admin@acc02.com')->first() ?: new User();
$u2->name = 'ACC02 Admin';
$u2->email = 'admin@acc02.com';
